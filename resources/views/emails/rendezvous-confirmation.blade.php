...
<body style="margin:0;padding:24px;background:#f8fafc;color:#0f172a;font-family:Arial,sans-serif;">
    <div style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:14px;overflow:hidden;">
        <div style="background:#0d9488;color:#ffffff;padding:18px 22px;">
            ...
            <table style="width:100%;border-collapse:collapse;font-size:14px;">
                <tbody>
                    <tr>
                        ...
                        <td style="padding:10px 0;border-bottom:1px solid #e2e8f0;text-align:right;">Dr. {{ $rendezvous->medecin->name ?? '-' }}</td>
                    </tr>
                    <tr>
                        <td style="padding:10px 0;border-bottom:1px solid #e2e8f0;color:#64748b;">{{ __('Service') }}</td>
                        <td style="padding:10px 0;border-bottom:1px solid #e2e8f0;text-align:right;">{{ $rendezvous->service->nom ?? '-' }}</td>
                    </tr>
                    <tr>
